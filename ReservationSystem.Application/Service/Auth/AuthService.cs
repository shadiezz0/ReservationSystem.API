...
namespace ReservationSystem.Application.Service.Auth
{
      public class AuthService : IAuthService 
      {
            ...
            public AuthService(IUnitOfWork uow, /*IEmailService emailService*/ ITokenService tokenService )
            {
                  _uow = uow;
            ...
            //      await _emailService.SendEmailAsync(email, "Password Reset", $"Your new password is: {newPass}");
